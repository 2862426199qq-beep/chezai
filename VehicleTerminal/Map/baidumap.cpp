    ...
    ui(new Ui::BaiduMap)
{
    ...
    printf("BaiduMap: calling gps_init...\n");
    fflush(stdout);
    gps_init();
    
    printf("BaiduMap: calling updateMap...\n");
    fflush(stdout);
    updateMap();
    
    printf("BaiduMap: initialization complete!\n");
    fflush(stdout);
}
...
{
    printf("BaiduMap::ReceiveMapImg called\n");
    fflush(stdout);
    ...
    if(data.isEmpty())
    {
        printf("BaiduMap::ReceiveMapImg: data is empty\n");
        fflush(stdout);
        qDebug()<<"data is null";
        return ;
    }
    printf("BaiduMap::ReceiveMapImg: writing %d bytes\n", data.size());
    fflush(stdout);
    ...
    printf("BaiduMap::ReceiveMapImg complete\n");
    fflush(stdout);
}
